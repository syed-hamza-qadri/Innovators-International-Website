    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <div className="mb-4 -ml-5 relative">
              <Image
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/locations" className="text-gray-300 hover:text-teal-400 transition-colors">
                  Locations
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services#it-solutions" className="text-gray-300 hover:text-teal-400 transition-colors">
                  IT Solutions
                </Link>
              </li>
              <li>
                <Link href="/services#ecommerce" className="text-gray-300 hover:text-teal-400 transition-colors">
                  E-Commerce
                </Link>
              </li>
              <li>
                <Link href="/services#consulting" className="text-gray-300 hover:text-teal-400 transition-colors">
                  Business Consulting
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Business Center, Sharjah Publishing City Free Zone, Sharjah, UAE</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-teal-400 mr-2" />
                <Link href="tel:+971508946620" className="text-gray-300 hover:text-teal-400 transition-colors">
                  +971 50 894 6620
                </Link>
              </li>
              <li className="flex items-center">
                ...
                <Link
                  href="mailto:info@innovatorsint.com"
                  className="text-gray-300 hover:text-teal-400 transition-colors"
                >
                  info@innovatorsint.com
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} Innovators International. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
